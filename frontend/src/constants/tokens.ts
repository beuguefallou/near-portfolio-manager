...
export const DEPOSIT_TOKEN_MAP: Record<string, string> = {
  ETH: "nep141:base-0x833589fcd6edb6e08f4c7c32d4f71b54bda02913.omft.near",
  SOL: "nep141:sol.omft.near",
};
export const LIST_TOKENS: IToken[] = [
  {
    unifiedAssetId: "usdc",
    decimals: 6,
    symbol: "USDC",
